function applySvmClassifier_perSubject_perFreq( iS, targetFS, nFoldsSvm )
...
for iRT = 1:numel(runsUsedForTest)
    ...
    targetStateSeq  = pars.lookHereStateSeq( pars.lookHereStateSeq~=max(pars.lookHereStateSeq) );
                    ...
                    for iF = 1:numel(pars.realP3StateSeqOnsets)
                        ...
                        targetSquare( ismember(targetId, (iF-1)*pars.nP3item+1:iF*pars.nP3item) ) = iF;
                    end    
