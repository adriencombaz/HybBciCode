...
for (iS in 1:5)
  ...
  filename <- sprintf("d:/KULeuven/PhD/Work/Hybrid-BCI/HybBciProcessedData/watch-ERP/02-ter-p3Classification/LinSvm_2RunsForTrain/subject_S%d/Results_forLogisiticRegression.txt", iS)
