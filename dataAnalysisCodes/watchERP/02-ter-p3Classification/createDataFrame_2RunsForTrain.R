...
for (iS in 1:8)
  ...
  filename <- sprintf("d:/KULeuven/PhD/Work/Hybrid-BCI/HybBciProcessedData/watchERP/02-ter-p3Classification/LinSvm_2RunsForTrain/subject_S%d/Results_forLogisiticRegression.txt", iS)
  ...
  filename <- sprintf("d:/KULeuven/PhD/Work/Hybrid-BCI/HybBciProcessedData/watchERP/02-ter-p3Classification/LinSvmPooled_2RunsForTrain/subject_S%d/Results_forLogisiticRegression.txt", iS)
