...
#   if (iS==8) 
#     {
#     filename <- sprintf("d:/KULeuven/PhD/Work/Hybrid-BCI/HybBciProcessedData/watchERP/02-ter-p3Classification/LinSvm/subject_S%d_EpochRejection/Results_forLogisiticRegression.txt", iS)
#     }
#     else
#     {
