...
fm2.lme <- lmer( psd ~ (stimDuration+I(stimDuration^2))*oddball + ((stimDuration+I(stimDuration^2))|subject/trialInSub), psdData )

fm2b.lme <- lmer( 
  psd ~ (stimDuration+I(stimDuration^2))*oddball 
  + ((0+stimDuration+I(stimDuration^2))|subject) + ((stimDuration+I(stimDuration^2))|subject:trialInSub)
  , psdData 
)
