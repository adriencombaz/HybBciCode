...
fm1.lme <- lme(
  sqrtPsd ~ (stimDuration+I(stimDuration^2))*oddball
#   sqrtPsd ~ stimDuration + stimDuration*oddball
  , data = psdDataGp
  , random =  ~(stimDuration+I(stimDuration^2)) | subject/trialInSub
#   , random = list(subject=pdDiag(~stimDuration), trialInSub=pdDiag(~stimDuration))
...
pp4b <- ggplot( psdData, aes(stimDuration, sqrtPsd, colour=oddball) )
...
fm3.lme <- update(fm1.lme, corr = corCompSymm()) 
fm3.lme <- update(fm1.lme, corr = corCAR1()) 
fm3.lme <- update(fm1.lme, corr = corARMA(p=1)) 
...
plot( fm3.lme, resid(., type = "normalized") ~ stimDuration|oddball, abline = 0 )
plot( fm3.lme, resid(., type = "normalized") ~ stimDuration|trialInSub, abline = 0 )
plot( fm3.lme, resid(., type = "normalized") ~ stimDuration|subject, abline = 0 )
plot( fm3.lme, resid(., type = "normalized") ~ stimDuration|subject*oddball, abline = 0 )

plot( fm3.lme, resid(., type = "normalized") ~ fitted(.), abline = 0 )
plot( fm3.lme, resid(., type = "normalized") ~ fitted(.)|oddball, abline = 0 )
plot( fm3.lme, resid(., type = "normalized") ~ fitted(.)|subject, abline = 0 )
plot( fm3.lme, resid(., type = "normalized") ~ fitted(.)|stimDuration, abline = 0 )
plot( fm2.lme, resid(., type = "normalized") ~ fitted(.)|stimDuration, abline = 0 )
plot( fm3.lme, resid(., type = "normalized") ~ fitted(.)|stimDuration*oddball, abline = 0 )
plot( fm3.lme, resid(., type = "normalized") ~ fitted(.)|subject*oddball, abline = 0 )
plot( fm3.lme, resid(.) ~ fitted(.)|stimDuration*subject, abline = 0 )
plot( fm3.lme, resid(.) ~ fitted(.)|stimDuration*subject*oddball, abline = 0 )

plot(ACF(fm3.lme, maxLag = 15, resType="n"), alpha = 0.01)
plot(ACF(fm3.lme, resType="n"), alpha = 0.01)
