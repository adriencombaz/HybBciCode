function computeSNRsTemp( iS, ha )
...
for iChanList = 1:numel(channelsList)
    for iHaList = 1:numel(harmonicList)
        ...
        fid(iChanList, iHaList) = fopen( fullfile( outDir, sprintf('snrs_original_subject%s.txt', sub{iS}) ),'wt' );
