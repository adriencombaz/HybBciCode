function buildPooledSvmClassifier_perSubject_useAllData( iS, aveList, nRunsForTraining, targetFS, nFoldsSvm )
...
resDir = fullfile( resDir, folderName, sprintf('LinSvmPooled_allData_%dRunsForTrain_%dHz_%.2dcvSvm', nRunsForTraining, targetFS, nFoldsSvm), sprintf('subject_%s', sub{iS}) );
