...
classdef mecSsvepClassifier < ssvepClassifier
    ...
    methods
        %-----------------------------------------------------------------------------------------------
        function obj = mecSsvepClassifier( varargin )
            
            obj = obj@ssvepClassifier( varargin{:} ); % call the superclass constructor
            obj.tag = 'MEC';
            obj.description = 'SSVEP classifier based on Minimum Energy Combination spatial filtering';
            ...
            obj.rangeSubWindow          = 0:obj.nSamplesInWindow-1;
            
            Zp = zeros( obj.nSamplesInWindow, 2*obj.nFrequenciesToRemove );
            ...
            obj.SSVEPRemovalMatrix = eye( obj.nSamplesInWindow ) - ( Zp * invertRealSymmetricMatrix( Zp'*Zp ) * Zp' );
        ...
        function [SNRs, Ns] = getSNRs( obj, inputEEGData )
            ...
            for iComb = 1:Ns,
                pxx = myPyulear( tildeS(iComb,:), obj.arParameter, obj.nFFT );
                ...
                switch( lower( parameterName ) ),
                    case{ 'nfft' },
                        if( isnumeric( parameterValue ) && isfinite( parameterValue ) ...
                            ...
                            error('mecSsvepClassifier:parseInputParameters:BadNumberOfFFT', ...
                    ...
                    case{ 'arparameter', 'autoregressionparameter' }, 
                        if( isnumeric( parameterValue ) && isfinite( parameterValue ) ...
                            ...
                            error('mecSsvepClassifier:parseInputParameters:BadArParameter', ...
...
end % of mecSsvepClassifier class definition