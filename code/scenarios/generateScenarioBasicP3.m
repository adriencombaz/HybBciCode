function generateScenarioBasicP3
...
generateScenarioAndStimuli(stimImageName, 'redDisk');
stimImageName = 'black-pixel.png';
generateScenarioAndStimuli(stimImageName, 'blackPixel');
    ...
    %==========================================================================
    %==========================================================================
    function generateScenarioAndStimuli(stimImageName, tag)
...
% % % %         end
        ...
        %% Write .xml scenario
        %==========================================================================
        scFileName = sprintf('basicP3-%.2d-square-%.2d-P300-stim-%s-@%dx%d.xml', nSSVEP, nEltPerSSVEP, tag, scrPos(3), scrPos(4));
