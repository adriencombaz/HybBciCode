...
switch hostName,
    case {'noone-laptop-xp', 'neu-wrk-0154'},
        eegDataDir  = 'd:/data/EEG-recordings/basicP3/';
    case 'neu-wrk-0139',
        eegDataDir  = 'C:/home/adrien/KULeuven/PhD/EEG-recordings/basicP3/';
    case 'neu-wrk-0161',
        eegDataDir  = 'C:/EEG-recordings/basicP3/';
...
switch stimulusType
    case 'blackPixel'
        scenario    = sprintf('basicP3-01-square-06-P300-stim-blackPixel-@%dx%d.xml', scrPos(3), scrPos(4));
    case 'redDisk'
        scenario    = sprintf('basicP3-01-square-06-P300-stim-redDisk-@%dx%d.xml', scrPos(3), scrPos(4));
end
