...
useLptPort                      = true;
showLog                         = true;
fastOrSlowList                  = {'fast', 'slow'};
fastOrSlow                      = fastOrSlowList{1};
gapOrNoGapList                  = {'gap', 'noGap'};
gapOrNoGap                      = gapOrNoGapList{1};
narrowOrSpreadList              = {'narrow', 'spread'};
narrowOrSpread                  = narrowOrSpreadList{1};
nRepetitions                    = 10;
nCuesToShow                     = 12;

parameterList = {
    'Subject name',                             subjectName,                'subjectName'
    'fast or slow',                             fastOrSlowList,             'fastOrSlow'
    'gap or no gap',                            gapOrNoGapList,             'gapOrNoGap'
    'narrow or spread',                         narrowOrSpreadList,         'narrowOrSpread'
...
switch hostName,
    case {'noone-laptop-xp', 'neu-wrk-0154'},
        eegDataDir  = 'd:/data/EEG-recordings/lookingForP3/';
    case 'neu-wrk-0139',
        eegDataDir  = 'C:/home/adrien/KULeuven/PhD/EEG-recordings/lookingForP3/';
    case 'neu-wrk-0161',
        eegDataDir  = 'C:/EEG-recordings/lookingForP3/';
    case 'kuleuven-24b13c',
        eegDataDir  = 'd:/KULeuven/PhD/Work/EEG-Recording/lookingForP3/';
    case 'neu-wrk-0158',
        eegDataDir  = 'd:/Adrien/Work/Hybrid-BCI/HybBciData/lookingForP3/';
    otherwise,
        eegDataDir  = './EEG-recordings/lookingForP3/';
end
...
switch narrowOrSpread
    case 'narrow'
        scenario    = sprintf('lookingForP3-06-P300-stim-redDisk-narrow@%dx%d.xml', scrPos(3), scrPos(4));
    case 'spread'
        scenario    = sprintf('lookingForP3-06-P300-stim-redDisk-spread@%dx%d.xml', scrPos(3), scrPos(4));
end
...
st.sc.stimuli(iBackgroundStim).durationSequenceInSec    = roundDurationInSec;
...
nMaxEvents  = round( 2 * ( 2 + numel(p3StateSeq) + numel(lookHereStateSeq) ) );
